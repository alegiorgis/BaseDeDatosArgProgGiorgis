...
--
-- Host: brld603k2dkm7brvfqkj-mysql.services.clever-cloud.com    Database: brld603k2dkm7brvfqkj
-- ------------------------------------------------------
...
a38a16d0-767a-11eb-abe2-cecd029e558e:1-157949779';
...
CREATE TABLE `experiencia` (
  ...
  `fechafin_exp` int DEFAULT NULL,
  `fechain_exp` int DEFAULT NULL,
  `imgen_exp` varchar(255) DEFAULT NULL,
...
CREATE TABLE `proyecto` (
  ...
  `desc_proy` varchar(255) DEFAULT NULL,
...
CREATE TABLE `skills` (
  ...
  `desc_skills` varchar(255) DEFAULT NULL,
  `foto_skills` varchar(255) DEFAULT NULL,
...
-- Dump completed on 2022-07-29 19:59:07
